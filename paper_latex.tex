...
Furthermore, to maximize the benefits of reducing the distance between the reference samples and predicted sample, we apply SAP-E \cite{09} in planar prediction mode, in which the predicted value is calculated as \eqref{planar} \cite{29}.
